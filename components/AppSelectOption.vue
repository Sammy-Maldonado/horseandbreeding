<template>
  ...
  <div class="mb-4 flex items-center">
    ...
    <select
      ...
      :id="name"
      :name="name"
      class="block w-full rounded-md border-0 p-2 pb-3 text-gray-900 shadow-xs ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm sm:leading-6"
    >
      {{
        selectedOption
      }}
