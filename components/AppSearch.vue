<template>
  <form class="flex items-center w-full mx-auto" @submit.prevent="search">
...
// submit method
const search = () => {
  emit("find", searchTerm.value);
};

// Create a reactive searchTerm, initialized with the prop `searchText`
